...
Source8: amazon-cloudwatch-agent.toml
...
install -p -m 0644 %{S:8} %{buildroot}%{_cross_factorydir}/opt/aws/amazon-cloudwatch-agent/etc/amazon-cloudwatch-agent.toml
...
%{_cross_factorydir}/opt/aws/amazon-cloudwatch-agent/etc/amazon-cloudwatch-agent.toml
